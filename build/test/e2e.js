...
gulp.task('test-e2e-instantiate-v0', () => {
    return gulp.src('*.js', {read: false})
        .pipe(shell([
...
gulp.task('test-e2e-invoke-v0-test1-test2', () => {
    return gulp.src('*.js', {read: false})
...
gulp.task('test-e2e-invoke-v0-test3', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test4', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test5', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test6', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test7', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test8', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test9', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test10', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test11', () => {
...
gulp.task('test-e2e-invoke-v0-test12', () => {
...
// Test decryption support in fabric-shim-crypto
gulp.task('test-e2e-invoke-v0-test13', () => {
    const cmd = 'docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent --transient ' +
...
// Test decryption support in fabric-shim-crypto
gulp.task('test-e2e-invoke-v0-test14', () => {
    const cmd = 'docker exec cli peer chaincode query %s -C %s -n %s -c %s --transient ' +
        '\'{"sign-key":"LS0tLS1CRUdJTiBQUklWQVRFIEtFWS0tLS0tTUlHSEFnRUFNQk1HQnlxR1NNNDlB' +
        'Z0VHQ0NxR1NNNDlBd0VIQkcwd2F3SUJBUVFnWllNdmYzdzVWa3p6c1RRWUk4WjhJWHVHRlptbWZqSVg' +
        'yWVNTY3FDdkFraWhSQU5DQUFTNkJoRmdXL3EwUHpya3dUNVJsV1R0NDFWZ1hMZ3VQdjZRS3ZHc1c3U3' +
...
gulp.task('test-e2e-invoke-v0-test15', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test16', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test17', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test18', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test19', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test20', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test21', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-invoke-v0-test22', () => {
    return gulp.src('*.js', {read: false})
        .pipe(wait(3000))
        .pipe(shell([
            util.format('docker exec cli peer chaincode invoke %s -C %s -n %s -c %s --waitForEvent',
...
gulp.task('test-e2e-shim', gulp.series(
    [
        'copy-chaincode',
        'test-e2e-install-v0',
        'test-e2e-instantiate-v0',
        'test-e2e-invoke-v0-test1-test2',
        'test-e2e-invoke-v0-test3',
        'test-e2e-invoke-v0-test4',
        'test-e2e-invoke-v0-test5',
        'test-e2e-invoke-v0-test6',
        'test-e2e-invoke-v0-test7',
        'test-e2e-invoke-v0-test8',
        'test-e2e-invoke-v0-test9',
        'test-e2e-invoke-v0-test10',
        'test-e2e-invoke-v0-test11',
        'test-e2e-invoke-v0-test12',
        'test-e2e-invoke-v0-test13',
        'test-e2e-invoke-v0-test14',
        'test-e2e-invoke-v0-test15',
        'test-e2e-invoke-v0-test16',
        'test-e2e-invoke-v0-test17',
        'test-e2e-invoke-v0-test18',
        'test-e2e-invoke-v0-test19',
        'test-e2e-invoke-v0-test20',
        'test-e2e-invoke-v0-test21',
        'test-e2e-invoke-v0-test22'
    ]
));
