...
describe('Chaincode clientidentity', () => {
    ...
    it('should create an instance of the client identity class', async function () {
        ...
        expect(payload.id).to.equal('x509::CN=buyer,OU=client,O=Hyperledger,ST=North Carolina,C=US::CN=ca.org2.example.com,O=org2.example.com,L=Hursley,S=Hampshire,C=UK', 'Test getID()');
    });
